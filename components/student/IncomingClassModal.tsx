            ...
            {isOpen && classInfo && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-md p-1 overflow-hidden"
                    >
                        <div className="relative p-8 flex flex-col items-center justify-center text-center space-y-6 bg-gradient-to-b from-indigo-50 to-white dark:from-slate-700 dark:to-slate-800 rounded-3xl">
                            ...
                            <div className="grid grid-cols-2 gap-4 w-full mt-4">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    onClick={onDecline}
                                    className="flex flex-col items-center justify-center p-4 rounded-2xl bg-red-50 text-red-600 hover:bg-red-100 transition-colors group"
                                >
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    onClick={onJoin}
                                    className="flex flex-col items-center justify-center p-4 rounded-2xl bg-green-50 text-green-600 hover:bg-green-100 transition-colors group shadow-sm border border-green-100"
                                >
