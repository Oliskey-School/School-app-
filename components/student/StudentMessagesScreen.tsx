...
const LOGGED_IN_STUDENT_ID = 4; // Fatima Bello
...
const StudentMessagesScreen: React.FC<StudentMessagesScreenProps> = ({ onSelectChat }) => {
    ...
    const filteredConversations = useMemo(() => {
        return mockConversations
            .filter(convo => {
                const isParticipant = convo.messages.some(msg => msg.senderId === LOGGED_IN_STUDENT_ID) || convo.participant.id === LOGGED_IN_STUDENT_ID;
