  ...
  const renderActiveSetting = () => {
    switch (activeSetting) {
        case 'editTeacherProfile':
            return <EditTeacherProfileScreen />;
        case 'cbtManagement':
      ...
      `}>
          <div className="flex-grow p-4 space-y-4 overflow-y-auto">
              <div className="flex flex-col items-center p-6 space-y-2 bg-white rounded-xl shadow-sm">
                  <img src={mockTeacher.avatarUrl} alt={mockTeacher.name} className="w-24 h-24 rounded-full object-cover border-4 border-white shadow-md flex-shrink-0 aspect-square"/>
