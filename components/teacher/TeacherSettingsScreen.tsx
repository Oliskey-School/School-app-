                ...
                <div className="flex-grow p-4 space-y-4 overflow-y-auto">
                    <div className="flex flex-col items-center p-6 space-y-2 bg-white rounded-xl shadow-sm">
                        ...
                        <div
                            ...
                            onClick={() => copyToClipboard(customId || (profile as any).schoolGeneratedId || (profile as any).school_generated_id)}
                        >
                            <span className="text-xs text-gray-600 font-mono font-medium">
                                {formatId(customId || (profile as any).schoolGeneratedId || (profile as any).school_generated_id) || 'ID: Standardizing...'}
                            </span>
