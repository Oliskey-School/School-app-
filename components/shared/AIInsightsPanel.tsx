...
const AIInsightsPanel = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-indigo-50 to-white rounded-2xl shadow-sm border border-indigo-100 p-5">
            ...
            {Array.isArray(insights.children) && insights.children.length > 0 && (
                <div className="space-y-2 mb-4">
                    {insights.children.map((c: any) => (
                        <div key={c.student_id} className="bg-white rounded-xl border border-gray-100 p-3 flex items-center justify-between">
