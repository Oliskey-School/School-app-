...
const IDCardGenerator: React.FC<IDCardGeneratorProps> = ({ user, userType }) => {
    ...
    return (
        <div className="flex flex-col items-center space-y-4 p-6">
            {/* ID Card Preview */}
            <div ref={cardRef} className="relative w-[856px] h-[540px] bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 rounded-3xl shadow-2xl overflow-hidden">
                {/* Background Pattern */}
                            ...
                            <>
                                <div className="flex space-x-6">
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold">Grade {(user as Student).grade}{(user as Student).section}</p>
                                    </div>
                                    <div>
                                        <p className="text-xs opacity-70 uppercase tracking-wider">ID Number</p>
                                        <p className="text-lg font-semibold">STU-{String(user.id).padStart(6, '0')}</p>
                                    </div>
                                </div>
                            ...
                            <>
                                <div className="flex space-x-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold">TCH-{String(user.id).padStart(6, '0')}</p>
                                    </div>
                                </div>
                            </>
                        )}
