...
const LOGGED_IN_PARENT_ID = 1002; // Mrs. Bello, child is Fatima Bello (ID 4)
...
const ParentMessagesScreen: React.FC<ParentMessagesScreenProps> = ({ onSelectChat }) => {
    ...
    const filteredConversations = useMemo(() => {
        return mockConversations
            .filter(convo => {
                const isParticipant = convo.messages.some(msg => msg.senderId === LOGGED_IN_PARENT_ID) || convo.participant.id === LOGGED_IN_PARENT_ID;
                ...
                if (activeFilter === 'Unread') {
                    ...
                    return lastMessage && lastMessage.senderId !== LOGGED_IN_PARENT_ID;
                }
                return true;
            })
