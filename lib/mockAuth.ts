...
export const MOCK_USERS: Record<string, any> = {
    ...
    proprietor: {
        id: '989dae98-678d-4476-9665-d150bcbf4a8b',
        email: DEMO_ACCOUNTS.proprietor.email,
        password: 'password123',
        role: 'proprietor',
        name: DEMO_ACCOUNTS.proprietor.name,
        metadata: {
            role: 'proprietor',
            full_name: DEMO_ACCOUNTS.proprietor.name,
    ...
    inspector: {
        id: '868a5e42-2d69-4ac4-995e-5b029b5d39bf',
        email: DEMO_ACCOUNTS.inspector.email,
        password: 'password123',
        role: 'inspector',
        name: DEMO_ACCOUNTS.inspector.name,
        metadata: {
            role: 'inspector',
            full_name: DEMO_ACCOUNTS.inspector.name,
    ...
    examofficer: {
        id: 'e6b098e7-5c0e-45e2-856f-2cd2997c572',
        email: DEMO_ACCOUNTS.examofficer.email,
        password: 'password123',
        role: 'examofficer',
        name: DEMO_ACCOUNTS.examofficer.name,
        metadata: {
            role: 'examofficer',
            full_name: DEMO_ACCOUNTS.examofficer.name,
            school_generated_id: 'OLISKEY_MAIN_EXA_0001',
            school_id: DEMO_SCHOOL_ID,
            branch_id: DEMO_BRANCH_ID,
            school_code: 'OLISKEY',
            branch_code: 'MAIN',
    ...
    complianceofficer: {
        id: '61da9551-94a9-4a18-b661-67bbd17a1ee4',
        email: DEMO_ACCOUNTS.complianceofficer.email,
        password: 'password123',
        role: 'complianceofficer',
        name: DEMO_ACCOUNTS.complianceofficer.name,
        metadata: {
            role: 'complianceofficer',
            full_name: DEMO_ACCOUNTS.complianceofficer.name,
            school_generated_id: 'OLISKEY_MAIN_COM_0001',
            school_id: DEMO_SCHOOL_ID,
            branch_id: DEMO_BRANCH_ID,
            school_code: 'OLISKEY',
            branch_code: 'MAIN',
