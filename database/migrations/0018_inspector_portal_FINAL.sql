...
-- Migration 0018: Inspector & Inspection System (FINAL CORRECTED VERSION)
...
-- =====================================================
-- 2. INSPECTION RECORDS (CORRECTED: school_id is UUID)
-- =====================================================
CREATE TABLE public.inspections (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    school_id UUID REFERENCES public.schools(id) ON DELETE CASCADE,  -- FIXED: Changed from INTEGER to UUID
