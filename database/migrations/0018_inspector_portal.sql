...
-- Migration 0018: Inspector & Inspection System
...
CREATE TABLE IF NOT EXISTS public.inspection_checklist_templates (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    title TEXT NOT NULL,
    category TEXT NOT NULL, -- 'Documentation', 'Facilities', 'Teaching Quality', 'Health & Safety'
    questions JSONB NOT NULL,
    -- Example structure: [{"id": 1, "question": "Is operating license valid?", "max_points": 5, "required": true}]
...
-- =====================================================
CREATE INDEX IF NOT EXISTS idx_inspections_school ON public.inspections(school_id);
...
CREATE INDEX IF NOT EXISTS idx_inspectors_email ON public.inspectors(contact_email);
CREATE INDEX IF NOT EXISTS idx_inspectors_code ON public.inspectors(inspector_code);
CREATE INDEX IF NOT EXISTS idx_inspection_responses_inspection ON public.inspection_responses(inspection_id);
...
-- COMPLETION MESSAGE
-- =====================================================
SELECT '✅ Inspector Portal Database Schema Created Successfully' as status;
