...
import { enrollStudent, getAllStudents, getStudentById, updateStudent, bulkUpdateStatus, deleteStudent, getMyProfile, getMyPerformance, getMyQuizResults, linkGuardian, assignStudentToClass, removeStudentFromClass } from '../controllers/student.controller';
